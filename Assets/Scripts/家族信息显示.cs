            ...
            else
            {
                ...
                if (响应 != null)
                {
                    if (响应.success)
                    {
                        ...
                        // 记录家族ID（用于离开家族组）
                        玩家数据 当前玩家 = 玩家数据管理.实例?.当前玩家数据;
                        int 旧家族ID = 当前玩家 != null && 当前玩家.家族 != null ? 当前玩家.家族.家族ID : -1;
                        ...
                        if (玩家数据管理.实例 != null)
                        {
                            ...
                            // 离开家族组（SignalR）
                            if (旧家族ID > 0 && SignalR连接管理.实例 != null)
                            {
                                SignalR连接管理.实例.离开家族组(旧家族ID);
                            }
                        }
